 ...
 * 
 * @modify Peter Vivo / http://fecni.com   blender like controll
 * 
 */

THREE.EditableControls = function ( object, domElement ) {
	...
	console.log(event.wheelDelta)
		_state = STATE.ZOOM
		_zoomStart = _zoomEnd  = _this.getMouseOnScreen(  event.wheelDeltaX , event.wheelDeltaY+120 * (screen.height/240) );					
	}
	*/
